"""
step2_ollama_preannotate_small.py

Reads approach_a/output/candidates_small.csv.
Writes approach_a/output/preannotated_small.csv.

Same schema as the big version:
- register_label: one of
    "informal", "neutral essay", "academic", "news", "ambiguous"
- register_markedness_llm: 0 or 1
- substitution_natural_llm: 0 or 1
- simpler_alternative_llm: a simpler English word or ""
- confidence_llm: integer 1, 2 or 3
"""
...
CANDIDATES_CSV = OUTPUT_DIR / "candidates_small.csv"
PREANNOTATED_CSV = OUTPUT_DIR / "preannotated_small.csv"
